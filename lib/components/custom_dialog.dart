...
class RichAlertDialog extends StatefulWidget {
  ...
  /// add sub2
  final Widget alertSubtitle2;
  final Widget alertSubtitle3;
  RichAlertDialog({
    Key key,
...
class _RichAlertDialogState extends State<RichAlertDialog> {
  Map<int, AssetImage> _typeAsset = {
    RichAlertType.ERROR: AssetImage("assets/dialog/dialog_error.png"),
    RichAlertType.SUCCESS: AssetImage("assets/dialog/dialog_success.png"),
    RichAlertType.WARNING: AssetImage("assets/dialog/dialog_warning.png"),
  };
                        ...
                        child: Card(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: dialogHeight / 20),
                              widget.alertSubtitle2 ?? Container(),
                              SizedBox(height: dialogHeight / 20),
                              widget.alertSubtitle3 ?? Container(),
